...
function get_data(){
	...
	var separador_dec = $('#select_separador_dec option:selected').val();
	var separador_mil = $('#select_separador_mil option:selected').val();
	...
	if(i == 0){
		alert('Debe seleccionar a lo menos una varible.');
		return;
	}
	...
	inSepDec = $('<input></input>').attr('type','hidden').attr('name','sep_dec').attr('value',separador_dec);
	inSepMil = $('<input></input>').attr('type','hidden').attr('name','sep_mil').attr('value',separador_mil);
	inFil = $('<input></input>').attr('type','hidden').attr('name','fil').attr('value',filas);
	
	postForm.append(inAcc).append(inSta).append(inFd).append(inFh).append(inDet).append(inTyp).append(inSep).append(inSepDec).append(inSepMil).append(inFil);

			...
			<div class="main">
				...
				<div class="content">
					...
					<div class="content-1col-nobox">
						<h1 class="webtemplate" id="top_title">Descarga de las Estaciones</h1>
						<p>
							<a href="javascript:getStationsDownloadInfo();">&#091;RECARGAR&#093;</a>
						</p>
						<div id="contenido">
							<img class="centernoborder" src="../img/loaders/loader-01.gif" id="fbloader_image" />
						</div>
						<script type="text/javascript">
							$(document).ready(function(){
								getStationsDownloadInfo();
							});
						</script>
					</div> 
